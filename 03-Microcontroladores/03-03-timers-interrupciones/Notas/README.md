...
```
1. Guardar recurso útil aquí temporalmente
2. Cuando tengas tiempo, clasificar:
   - Teoría → ../theory/
   - Ejercicio → ../problems/
   - Multimedia → ../media/
3. Al mover, aplicar nomenclatura y metadatos estándar
```
...
> 🏠 Esta carpeta NO se incluye en validaciones del repositorio.
